...
var server = http.createServer(function (req, res) {
    ...
    } else if (req.requrl.pathname === '/sum') {
        require('./sum-node').get(req, res);
    } else if (req.requrl.pathname === '/subtract') {
        require('./subtract-node').get(req, res);
    } else if (req.requrl.pathname === '/divide') {
        require('./divide-node').get(req, res);
